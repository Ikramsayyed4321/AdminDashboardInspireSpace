<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Sign-in.aspx.cs" Inherits="AdminInspireSpace.signi_in" %>
                            ...
                            <form class="mt-4" runat="server">
                                ...
                                <div class="d-inline-block w-100">
                                    <div class="custom-control custom-checkbox d-inline-block mt-2 pt-1">
                                        ...
                                        CssClass="btn btn-primary btn-md btn-block iq-waves-effect text-center m-b-20" OnClick="btnLogin_Click" ></asp:Button>
                                    <asp:Label ID="lblError" runat="server" Text=""></asp:Label>
                                </div>
                                <div class="sign-info">
                                    <span class="dark-color d-inline-block line-height-2">Don't have an account? <a href="signup.aspx">Sign up</a></span>
